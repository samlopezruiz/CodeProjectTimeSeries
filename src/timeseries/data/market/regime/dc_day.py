...
if __name__ == '__main__':
    ...
    final_dc = pd.concat([df['ESc'], dc_df['dc']], axis=1)
    ...
    regime_cfg = {'n_clusters': 5, 'ema_p': 5, 'multiplier': 2,  'thold_k': 0.7}
    ...
    #%%
    plotly_ts_regime(df, rows=[0, 1], features=['ESc', 'atr'], markers='lines+markers', regimes=regimes, save=save_plots,
