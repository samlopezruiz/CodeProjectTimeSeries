...
from timeseries.experiments.lorenz.univariate.multistep.stroganoff.func import stroganoff_get_multi_step_uv_funcs


def stroganoff_uv_configs(steps=1):
    keys = {6: 0, 3: 1, 1: 2}
    good_configs = []
    ...
    functions = stroganoff_get_multi_step_uv_funcs()
