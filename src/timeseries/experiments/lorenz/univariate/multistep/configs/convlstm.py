...
from timeseries.experiments.lorenz.univariate.multistep.convlstm.func import convlstm_get_multi_step_uv_funcs


def convlstm_uv_configs(steps=1):
    keys = {6: 0, 3: 1, 1: 2}
    good_configs = []
    ...
    functions = convlstm_get_multi_step_uv_funcs()
