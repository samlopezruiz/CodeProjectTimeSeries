from timeseries.experiments.lorenz.univariate.multistep.configs.cnn import cnn_uv_configs
from timeseries.experiments.lorenz.univariate.multistep.configs.cnnlstm import cnnlstm_uv_configs
from timeseries.experiments.lorenz.univariate.multistep.configs.convlstm import convlstm_uv_configs
from timeseries.experiments.lorenz.univariate.multistep.configs.dcnn import dcnn_uv_configs
from timeseries.experiments.lorenz.univariate.multistep.configs.gpregress import gpregress_uv_configs
from timeseries.experiments.lorenz.univariate.multistep.configs.stroganoff import stroganoff_uv_configs
from timeseries.experiments.lorenz.univariate.multistep.configs.wavenet import wavenet_uv_configs
from timeseries.experiments.lorenz.univariate.onestep.configs.arima import arima_uv_configs
