...
from timeseries.experiments.lorenz.univariate.onestep.cnnlstm.func import cnnlstm_one_step_uv_predict, \
...
if __name__ == '__main__':
    ...
    #%% EVALUATE
    scores, preds = repeat_evaluate(train, test, cfg, cnnlstm_one_step_uv_predict, cnnlstm_one_step_uv_fit, n_repeats=10)
