import os
from timeseries.experiments.lorenz.functions.dataprep import row_col_one_step_xy_from_mv, row_col_multi_step_xy_from_mv
import numpy as np
...
if __name__ == '__main__':
    ...
    # split into samples
    X, y = row_col_multi_step_xy_from_mv(seqs, n_steps_in, n_steps_out, n_seq)
