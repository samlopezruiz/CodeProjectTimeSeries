...
from timeseries.experiments.lorenz.multivariate.multistep.lstm.func import lstm_multi_step_mv_fit, lstm_multi_step_mv_predict
from timeseries.experiments.lorenz.multivariate.onestep.lstm.func import lstm_one_step_mv_fit, lstm_one_step_mv_predict
from timeseries.experiments.lorenz.univariate.onestep.lstm.func import lstm_one_step_uv_fit, lstm_one_step_uv_predict
...
if __name__ == '__main__':
    ...
    # %% FORECAST
    # model = lstm_multi_step_mv_fit(train, cfg)
    # # history doesn't contain last y column
    # history = train[:, :-1]
    # pred = lstm_multi_step_mv_predict(model, history, cfg)
    ...
    error, forecast = walk_forward_step_forecast(train, test, cfg, lstm_multi_step_mv_predict, lstm_multi_step_mv_fit,
