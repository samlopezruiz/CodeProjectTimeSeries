...
from timeseries.experiments.lorenz.multivariate.multistep.configs.gpregress import gpregress_mv_configs
...
if __name__ == '__main__':
    # %% GENERAL INPUTS
    in_cfg = {'steps': 1, 'save_results': True, 'verbose': 1, 'plot_title': False, 'plot_hist': False,
              'image_folder': 'forecast_img', 'results_folder': 'results',}

    # MODEL AND TIME SERIES INPUTS
    name, input_cfg, model_cfg, functions = gpregress_mv_configs(steps=in_cfg['steps'])
