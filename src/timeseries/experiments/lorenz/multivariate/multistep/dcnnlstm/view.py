...
from timeseries.experiments.lorenz.multivariate.multistep.configs.dcnnlstm import dcnnlstm_mv_configs
...
if __name__ == '__main__':
    ...
    name, input_cfg, model_cfg, functions = dcnnlstm_mv_configs(steps=in_cfg['steps'])
