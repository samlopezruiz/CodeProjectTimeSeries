...
from timeseries.experiments.lorenz.multivariate.onestep.cnn.func import cnn_one_step_mv_fit, cnn_one_step_mv_predict
from timeseries.experiments.lorenz.multivariate.onestep.mlp.func import mlp_one_step_mv_predict
