...
from timeseries.models.market.preprocess.func import add_features
from timeseries.models.market.split.func import time_subset
from timeseries.models.market.utils.save import save_hmm
...
if __name__ == '__main__':
    ...
    save_hmm([df_reg, n_regimes, df_proba, hmm_cfg, data_cfgs], in_cfg, hmm_cfg)
