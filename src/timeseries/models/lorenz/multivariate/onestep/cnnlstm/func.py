...
from timeseries.models.lorenz.functions.dataprep import step_feature_one_step_xy_from_uv, \
    step_feature_one_step_xy_from_mv
from numpy import array


def cnnlstm_one_step_mv_fit(train, cfg):
    ...
    # prepare data
    X, y = step_feature_one_step_xy_from_mv(train, n_input, n_seq)
...
def cnnlstm_one_step_mv_predict(model, history, cfg, steps=1):
    # unpack architectures
