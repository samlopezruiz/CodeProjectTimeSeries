...
from timeseries.models.lorenz.multivariate.multistep.dcnn.func import dcnn_multi_step_mv_fit, dcnn_multi_step_mv_predict
...
if __name__ == '__main__':
    ...
    model_cfg = {"n_steps_in": 50, "n_steps_out": 6, 'n_layers': 5, "n_filters": 100,
    ...
    # %% FORECAST
    model = dcnn_multi_step_mv_fit(train_pp, model_cfg, verbose=1)
    # history doesn't contain last y column
    history = train_pp[:, :-1]
    forecast = dcnn_multi_step_mv_predict(model, history, model_cfg)
    ...
    # forecast = walk_forward_step_forecast(train_pp, test_pp, model_cfg, dcnn_multi_step_mv_predict,
    #                                       dcnn_multi_step_mv_fit, steps=model_cfg['n_steps_out'],
