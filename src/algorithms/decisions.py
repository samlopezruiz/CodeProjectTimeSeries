...
# MOOSRA
from py_decisions.moora.multimoora import multimoora_method

# MULTIMOORA
from py_decisions.moora.moosra import moosra_method
...
concordance, discordance, dominance, kernel, dominated = electre_i(dataset, W=W, remove_cycles=True, c_hat=0.75,
                                                                   d_hat=0.50, graph=True)
...
global_concordance, discordance, kernel, credibility, dominated = electre_i_s(dataset, Q=Q, P=P, V=V, W=W, graph=True,
...
concordance, discordance, dominance, kernel, dominated = electre_i_v(dataset, V=V, W=W, remove_cycles=True, c_hat=c_hat,
                                                                     graph=True)
...
concordance, discordance, dominance_s, dominance_w, rank_D, rank_A, rank_N, rank_P = electre_ii(dataset, W=W,
                                                                                                c_minus=c_minus,
                                                                                                c_zero=c_zero,
                                                                                                c_plus=c_plus,
                                                                                                d_minus=d_minus,
...
W = [9.00, 8.24, 5.98, 8.48]
F = ['t5', 't5', 't5',
     't5']  # 't1' = Usual; 't2' = U-Shape; 't3' = V-Shape; 't4' = Level; 't5' = V-Shape with Indifference; 't6' = Gaussian; 't7' = C-Form
...
# Call Promethee V
p5 = promethee_v(dataset, W=W, Q=Q, S=S, P=P, F=F, sort=True, criteria=criteria, cost=cost, budget=budget,
                 forbidden=forbidden, iterations=500)
...
# Call Promethee VI
p6_minus, p6, p6_plus = promethee_vi(dataset, W_lower=W_lower, W_upper=W_upper, Q=Q, S=S, P=P, F=F, sort=True, topn=10,
                                     iterations=1000, graph=True)
